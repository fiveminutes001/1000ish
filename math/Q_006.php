		...
		<table style="width:100%;text-align:center;border:1px black solid;">
			...
			<tr>
				...
				<td style="direction:rtl;text-align:center;">
					<b>מחפשים מספר שיאפס את המשוואה. במקרה הזה: x = -2</b>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td style="direction:ltr;text-align:center;">
					...
					\require{enclose}
					\begin{array}{rll}
						x^2-2x+3 && \hbox{(Explanations)} \\[-3pt]
					(x+2) \enclose{longdiv}{x^3+0*x^2-x+6}\kern-.2ex \\[-3pt]
						\underline{x^3+2x^2\phantom{000000000}} && \hbox{($x^2 \times x = x^3 , x^2 \times 2 = 2x^2$)} \\[-3pt]
						-2x^2-x\phantom{00000} && \hbox{($x^3-x^3=0 , 0 - 2x^2 = - 2x^2$)} \\[-3pt]
						\underline{\phantom{0}-2x^2-4x\phantom{0000}} && \hbox{($-2x \times x=-2x^2 , -2x \times 2=-4x$)} \\[-3pt]
						3x+6\phantom{} && \hbox{($2x^2-(-2x^2)=0,-x-(-4x)=3x$)} \\[-3pt]
						\underline{\phantom{0}3x+6} && \hbox{($3 \times x = 3x , 3 \times 2 = 6$)} \\[-3pt]
						\phantom{00}0
					\end{array}
					$$
				</td>
			...
			<tr>
				...
				<td style="direction:rtl;text-align:center;">
					<b>פיתרון אחד כבר יש, x=-2.<br>את השני והשלישי אם יש מקבלים מפתרון משוואה ריבועית:</b>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td style="direction:rtl;text-align:center;">
					<b>במקרה זה אין עוד פתרונות.<br>x=-2 הוא הפתרון היחיד.</b>
				</td>
			</tr>
		</table>
	</div>
