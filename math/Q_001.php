	...
	<div style="width:100%;">
		<table style="width:100%;text-align:center;border:1px black solid;">
			...
			<tr>
				...
				<td style="direction:rtl;text-align:center;">
					$$\frac{20*20}{20x}+\frac{5*1}{20x} = \frac{4*10}{20x}+\frac{5*x}{20x}$$
				</td>
			</tr>
			<tr>
				<td>
				...
				<td style="direction:rtl;text-align:center;">
					$$\frac{400}{20x}+\frac{5}{20x} = \frac{40}{20x}+\frac{5x}{20x}$$
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td style="direction:rtl;text-align:center;">
					<b>העברת אגפים כך ש-x ישאר לבד</b>
				</td>
			</tr>
			<tr>
				<td>
