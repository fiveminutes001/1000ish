...
// CHECKING SESSION VAR
	if($_SESSION['from_upload'] == 1)
	{
		...
		$original_image_name = substr($_POST['file_01'], 11, strlen($_POST['file_01']));
		...
		{	
			if($_SESSION['times_rotated_right_03'] == 1)
			{
				...
				//RENAME IMAGE FILE
				$rotated_image_name = "../uploads/".$original_image_name_no_extension."_0".$_SESSION['times_rotated_right_03'].".".$_POST['extension_01'];
