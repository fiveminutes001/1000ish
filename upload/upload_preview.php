...
// SESSION VARS
	$_SESSION['uploading_1st_pic'] = 1;
	$_SESSION['uploading_2nd_pic'] = 0;
	$_SESSION['uploading_3rd_pic'] = 0;
	
	$_SESSION['uploaded_1st_pic'] = 0 ;
	$_SESSION['uploaded_2nd_pic'] = 0 ;
	$_SESSION['uploaded_3rd_pic'] = 0 ;

	$_SESSION['upload_complete'] = 0;
			...
			{ 
				...
				if($_SESSION["ok_flag"] != 0)
				{
					...
					if($_POST["name_field"] != "name_00" && $_POST["animal_field"] == "animal_07" && $_POST["color_field"] == "color_04" && $_POST["country"] == "איטליה")
					{
						...
						//UPLOADING PIC
						if((($_SESSION['uploading_1st_pic'] == 1)&&($_SESSION['uploaded_1st_pic'] != 1))||(($_SESSION['uploading_2nd_pic'] == 1)&&($_SESSION['uploaded_2nd_pic'] != 1))||(($_SESSION['uploading_3rd_pic'] == 1)&&($_SESSION['uploaded_3rd_pic'] != 1)))
						{
							if($_SESSION['upload_complete'] != 1)
							{
						...
						//UPLOADING FIRST PIC
						if(($_SESSION['uploading_1st_pic'] == 1)&&($_SESSION['uploaded_1st_pic'] != 1))
						{
							echo '
											<tr>
												<td>
						...
						//UPLOADING SECOND PIC
						if(($_SESSION['uploading_2nd_pic'] == 1)&&($_SESSION['uploaded_2nd_pic'] != 1))
						{
							echo	'
											<tr>
												<td>
						...
						//UPLOADING THIRD PIC
						if(($_SESSION['uploading_3rd_pic'] == 1)&&($_SESSION['uploaded_3rd_pic'] != 1))
						{
							echo	'				
											<tr>
												<td>
