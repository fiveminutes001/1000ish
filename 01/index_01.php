...
function show_(a)
{
	...
	if(a == "IDO" || a=="ITAY" || a=="SHACHAR")
	{
		...
		var all_together = four_units_equations + desmos + geometry_sentences;
		
		if(a == "IDO")
		{
			var all_together = physics_equations + four_units_equations + desmos + geometry_sentences;
		}
		
		$("#div_pages").html(all_together);
	}
	else if(a == "MAAYAN" || a == "DAVID" || a == "MAYA")
	{
		...
		var desmos = "<div class='formula_buttons_div'><a target='blank' href='https://www.desmos.com/calculator'><div class='formula_buttons'>דסמוס</div></a></div>";
		var geometry_sentences = "<div class='formula_buttons_div'><a target='blank' href='http://s3-eu-west-1.amazonaws.com/schooly/gymnasia-jerusalem/gymnasia-jerusalem/%D7%9E%D7%A9%D7%A4%D7%98%D7%99%D7%9D_%D7%91%D7%92%D7%99%D7%90%D7%95%D7%9E%D7%98%D7%A8%D7%99%D7%94_%D7%A2%D7%9D_%D7%A9%D7%A8%D7%98%D7%95%D7%98.pdf'><div class='formula_buttons'>גאומטריה</div></a></div>";
		var all_together = five_units_equations + desmos + geometry_sentences;
		$("#div_pages").html(all_together);
	}
	else if(a == "NETA" || a == "ODIL" || a == "NAAMA" || a == "DANA" || a == "NOA DANKER" || a == "EVYATAR" || a == "ITAMAR_TA" || a == "DANIEL" || a == "NATALY" || a == "OMRI" || a == "ODED" || a == "YONATAN")
	{
		var physics_equations = "<div class='formula_buttons_div'><a target='blank' href='https://files.geva.co.il/articlefile_1183972313359.pdf'><div class='formula_buttons'>פיזיקה</div></a></div>";
		var four_units_equations = "<div class='formula_buttons_div'><a target='blank' href='http://cms.education.gov.il/NR/rdonlyres/3B5F6DE8-EF8D-4F7E-BA96-A5E2DCB5DB2A/119742/4Yachal2.pdf'><div class='formula_buttons'>מתמטיקה</div></a></div>";
		var five_units_equations = "<div class='formula_buttons_div'><a target='blank' href='http://cms.education.gov.il/NR/rdonlyres/3B5F6DE8-EF8D-4F7E-BA96-A5E2DCB5DB2A/119745/5m.pdf'><div class='formula_buttons'>מתמטיקה</div></a></div>";
		var desmos = "<div class='formula_buttons_div'><a target='blank' href='https://www.desmos.com/calculator'><div class='formula_buttons'>דסמוס</div></a></div>";
		var geometry_sentences = "<div class='formula_buttons_div'><a target='blank' href='http://s3-eu-west-1.amazonaws.com/schooly/gymnasia-jerusalem/gymnasia-jerusalem/%D7%9E%D7%A9%D7%A4%D7%98%D7%99%D7%9D_%D7%91%D7%92%D7%99%D7%90%D7%95%D7%9E%D7%98%D7%A8%D7%99%D7%94_%D7%A2%D7%9D_%D7%A9%D7%A8%D7%98%D7%95%D7%98.pdf'><div class='formula_buttons'>גאומטריה</div></a></div>";
		var all_together = physics_equations + five_units_equations + desmos + geometry_sentences;
...
<div class="header" style="overflow:hidden;">
	...
	<div style="width:100%;display:inline-block;">	
		<div style="width:100%;text-align:center;">
			<div style="width:10%;display:inline;">
				<div onclick="alert('add new person')" style="border:0px;display:inline;" class="cursor_pointer">
					<h1 style="margin-bottom:0px;display:inline;float:right;">+</h1>
				</div>
			</div>
			<div style="width:10%;display:inline;">
				<div onclick="alert('remove person')" style="border:0px;display:inline;" class="cursor_pointer">
					<h1 style="margin-bottom:0px;display:inline;float:left;">-</h1>
				</div>
			</div>
			<div style="border:0px;display:inline;">
				<h1 style="margin-bottom:0px;display:inline;">אנשים</h1>
	...
	<!-- TOP MENU -->
	<div style="width:100%;display:inline-block;display:none;">	
		<h1 style="margin-bottom:0px;display:inline;">נושאים</h1>
		<h1 style="margin-bottom:0px;display:inline;"><hr></h1>
	</div>
	
	<!-- TOP MENU -->
	<div class="header" style="white-space: nowrap;display:none;">
		<!-- Slideshow container -->
		...
		<div class="initial_width button_02_ subjects" style="width:100%;">
			...
			<div class="initial_width button_02_">
				<div onclick="show_('YOSHIYAHU')" class="initial_width to_complete_02">
					חיכוך
				</div>
				
				<div onclick="show_('GROUP 02')" class="initial_width to_complete_02">
					תנע - התנגשות חד מימדית
				</div>
				
				<div onclick="show_('ITAY')" class="initial_width to_complete_02">
			...
			<!-- PHYSICS 02 -->
			<div class="initial_width button_02_">
				<div onclick="show_('JOY')" class="initial_width to_complete_03">
					פריקת וטעינת קבל
				</div>
				
				<div onclick="show_('SHON')" class="initial_width to_complete_03">
					כח על מטען
				</div>
				
				<div onclick="show_('ITAY')" class="initial_width to_complete_03">
					כוחות בין תיילים
				</div>
		...
		<div class="initial_width button_02_ subjects" style="width:100%;">
			<!-- MATH 800 -->
			<div class="initial_width button_02_">
				<div onclick="show_('YOSHIYAHU')" class="initial_width to_complete_02" style="white-space:initial;">
...
<div class="header" id="div1">
	<div style="width:100%;">	
		<h1 style="margin-bottom:0px;display:inline;">15.02.19 // עידו<i class="em em-anchor"></i></h1>
		<h1 onclick="alert('add new class')" style="margin-bottom:0px;display:inline;float:right;" class="cursor_pointer">+</h1>
		<h1 onclick="alert('remove this class')" style="margin-bottom:0px;display:inline;float:left;" class="cursor_pointer">-</h1>
	</div>
