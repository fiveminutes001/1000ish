...
<body>
	...
	<!-- TABLE -->
	<h1 style="text-align:center;">טבלה דינמית</h1>
	...
	<div style="width:100%;">
		<form action="bus_005_ENTER_DATA.php" method="POST">
			<table style="width:100%;text-align:center;border:1px black solid;">
				...
				<tr>
					<th colspan="4">
						<h3>סט:<input type="text" name="SET_1"></h3>
					</th>
				</tr>
				<tr>
					<th colspan="4" style="text-align:center;">
						<h3>תרגיל:<input type="text" name="HEADER_1"></h3>
					</th>
				</tr>
				<tr>
					<th colspan="4" style="text-align:center;">
						<h3>שם:<input type="text" name="NAME_1"></h3>
					</th>
				</tr>
				<tr>
					<th style="width:10%;">
