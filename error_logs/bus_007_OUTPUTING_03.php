...
<body>
	...
	if(!empty($_POST["NAME_1"]) || !empty($_POST["SET_1"]) || !empty($_POST["HEADER_1"]))
	{
		$check_post = 1;
	}
	else
	...
	//SEARCH WAS PREFORMED, DISPLAY RESULTS
	if($check_post)
	{
		$n = 0;
		$n_plus_1 = 1;
		...
		while ($n<count($drillArray))
		{
				...
				<table style="width:100%;text-align:center;border:1px black solid;">
					...
					<tr>
						...
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n]['LINK_01'].'">'.$drillArray[$n]['LINK_01_HEADER'].'</a>
						</td>
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n]['LINK_02'].'">'.$drillArray[$n]['LINK_02_HEADER'].'</a>
						</td>
						<td>
					...
					<tr>
						...
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_1]['LINK_01'].'">'.$drillArray[$n_plus_1]['LINK_01_HEADER'].'</a>
						</td>
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_1]['LINK_02'].'">'.$drillArray[$n_plus_1]['LINK_02_HEADER'].'</a>
						</td>
						<td>
					...
					<tr>
						...
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_2]['LINK_01'].'">'.$drillArray[$n_plus_2]['LINK_01_HEADER'].'</a>
						</td>
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_2]['LINK_02'].'">'.$drillArray[$n_plus_2]['LINK_02_HEADER'].'</a>
						</td>
						<td>
					...
					<tr>
						...
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_3]['LINK_01'].'">'.$drillArray[$n_plus_3]['LINK_01_HEADER'].'</a>
						</td>
						<td style="direction:rtl;text-align:center;">
							<a target="_blank" href="'.$drillArray[$n_plus_3]['LINK_02'].'">'.$drillArray[$n_plus_3]['LINK_02_HEADER'].'</a>
						</td>
						<td>
			...
			for($i=$n;$i<$n_plus_4;$i++)
			{
				if(!empty($drillArray[$i]["LINK_01"]))
				{
					echo '
					<!-- TABLE -->
					<h4 style="text-align:left;">'.$drillArray[$i]["DRILL_NUMBER"].'</h4>
