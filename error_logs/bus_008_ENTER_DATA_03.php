<?php
//VARS
	$a_01 = "bus_008_ENTER_DATA_03.php";
...
//QUERIES
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		for($m=1;$m<5;$m++)
		{
			if($m == 1)
			{
				$sql1="INSERT INTO drills (HEADER_NAME, SET_NUMBER, DRILL_NUMBER, LINK_01, LINK_02, LINK_01_HEADER, LINK_02_HEADER) VALUES ('$a[2]','$a[0]','$a[1]','$a[4]','$a[5]','$a[3]','$a[6]')";
			...
			if($m == 2)
			{
				$sql1="INSERT INTO drills (HEADER_NAME, SET_NUMBER, DRILL_NUMBER, LINK_01, LINK_02, LINK_01_HEADER, LINK_02_HEADER) VALUES ('$b[2]','$b[0]','$b[1]','$b[4]','$b[5]','$b[3]','$b[6]')";
				$query = mysqli_query($con,$sql1);
				$m++;
			}
			...
			if($m == 3)
			{
				$sql1="INSERT INTO drills (HEADER_NAME, SET_NUMBER, DRILL_NUMBER, LINK_01, LINK_02, LINK_01_HEADER, LINK_02_HEADER) VALUES ('$c[2]','$c[0]','$c[1]','$c[4]','$c[5]','$c[3]','$c[6]')";
				$query = mysqli_query($con,$sql1);
				$m++;
			}
			...
			if($m == 4)
			{
				$sql1="INSERT INTO drills (HEADER_NAME, SET_NUMBER, DRILL_NUMBER, LINK_01, LINK_02, LINK_01_HEADER, LINK_02_HEADER) VALUES ('$d[2]','$d[0]','$d[1]','$d[4]','$d[5]','$d[3]','$d[6]')";
				$query = mysqli_query($con,$sql1);
				$m++;
			}
		}
			...
			<table style="width:100%;text-align:center;border:1px black solid;">
				...
				<tr>
					...
					<td style="direction:rtl;text-align:center;">
						...
						לינק:
						<textarea id="text_1_01" onkeyup="get_data_1_01()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
					...
					<td style="direction:rtl;text-align:center;">
						...
						<textarea id="no_need_01_00" onkeyup="no_need_01()" style="width:100%;text-align:center;" rows="4" cols="50" placeholder="אין צורך"></textarea>
						
						<!-- NEW LINE -->
						<br>
						
						לינק:
						<textarea id="text_1_02" onkeyup="get_data_1_02()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
				...
				<tr>
					...
					<td style="direction:rtl;text-align:center;">
						...
						לינק:
						<textarea id="text_2_01" onkeyup="get_data_2_01()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
					...
					<td style="direction:rtl;text-align:center;">
						...
						<textarea id="no_need_02_00" onkeyup="no_need_02()" style="width:100%;text-align:center;" rows="4" cols="50" placeholder="אין צורך"></textarea>
						
						<!-- NEW LINE -->
						<br>
						
						לינק:
						<textarea id="text_2_02" onkeyup="get_data_2_02()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
				...
				<tr>
					...
					<td style="direction:rtl;text-align:center;">
						...
						לינק:
						<textarea id="text_3_01" onkeyup="get_data_3_01()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
					...
					<td style="direction:rtl;text-align:center;">
						...
						<textarea id="no_need_03_00" onkeyup="no_need_03()" style="width:100%;text-align:center;" rows="4" cols="50" placeholder="אין צורך"></textarea>
						
						<!-- NEW LINE -->
						<br>
						
						לינק:
						<textarea id="text_3_02" onkeyup="get_data_3_02()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
				...
				<tr>
					...
					<td style="direction:rtl;text-align:center;">
						...
						לינק:
						<textarea id="text_4_01" onkeyup="get_data_4_01()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
					...
					<td style="direction:rtl;text-align:center;">
						...
						<textarea id="no_need_04_00" onkeyup="no_need_04()" style="width:100%;text-align:center;" rows="4" cols="50" placeholder="אין צורך"></textarea>
						
						<!-- NEW LINE -->
						<br>
						
						לינק:
						<textarea id="text_4_02" onkeyup="get_data_4_02()" style="width:100%;direction:ltr;" rows="4" cols="50"></textarea>
