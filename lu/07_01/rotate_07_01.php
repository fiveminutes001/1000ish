...
// CHECKING SESSION VAR
	if($_SESSION['from_upload'] == 1)
	{
		...
		//ROTATING IMAGE
		//IF SESSION VAR > 8
		if($_SESSION['times_rotated_right'] > 8)
		{
			//SESSION VAR
			$_SESSION["rotated"] = 2;
		...
		{	
			if($_SESSION['times_rotated_right'] == 1)
			{
				$image = imagerotate($image,270,0);
				
				//RENAME IMAGE FILE
				$rotated_image_name = "uploads/".$original_image_name_no_extension."_0".$_SESSION['times_rotated_right'].".".$_POST['extension_01'];
			...
			if($_SESSION['times_rotated_right'] == 2)
			{
			...
			if($_SESSION['times_rotated_right'] == 3)
			{
			...
			if($_SESSION['times_rotated_right'] == 4)
			{
			...
			if(($_SESSION['times_rotated_right'] > 4)&&($_SESSION['times_rotated_right'] % 4) == 0)
			{
				//RENAME IMAGE FILE
			...
			if(($_SESSION['times_rotated_right'] > 3)&&(($_SESSION['times_rotated_right'] % 3) == 0)&&(($_SESSION['times_rotated_right'] % 2) != 0))
			{
				//RENAME IMAGE FILE
			...
			if(($_SESSION['times_rotated_right'] > 2)&&(($_SESSION['times_rotated_right'] % 4) != 0)&&(($_SESSION['times_rotated_right'] % 2) == 0))
			{
				//RENAME IMAGE FILE
			...
			if($_SESSION['times_rotated_right'] == 7)
			{
				//RENAME IMAGE FILE
				$rotated_image_name = "uploads/".$original_image_name_no_extension."_03.".$_POST['extension_01'];
			...
			if($_SESSION['rotated'] == 0 && $_SESSION['times_rotated_right'] > 4)
			{
				//RENAME IMAGE FILE
