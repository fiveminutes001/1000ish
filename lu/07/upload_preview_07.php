						...
						echo '	<div style="width:100%;text-align:center;direction:rtl;">
									<form action="upload.php" method="post" enctype="multipart/form-data">
										<table style="text-align:center;margin:auto;">
											...
											<tr>
												<td style="height:150px;width:150px;border:1px black solid;text-align:center;">
												<h1 style="margin:0px;">04</h1>
												</td>
											</tr>
											<tr>
												<td style="text-align:center;">
													<input type="file" name="image_upload_04" id="image_upload_04">
												</td>
											</tr>
											...
											<tr>
												<td style="height:150px;width:150px;border:1px black solid;text-align:center;">
												<h1 style="margin:0px;">05</h1>
												</td>
											</tr>
											<tr>
												<td style="text-align:center;">
													<input type="file" name="image_upload_05" id="image_upload_05">
												</td>
											</tr>
											...
											<tr>
												<td style="height:150px;width:150px;border:1px black solid;text-align:center;">
												<h1 style="margin:0px;">06</h1>
												</td>
											</tr>
											
											<tr>
												<td style="text-align:center;">
													<input type="file" name="image_upload_06" id="image_upload_06">
												</td>
											</tr>
											...
											<tr>
												<td style="height:150px;width:150px;border:1px black solid;text-align:center;">
												<h1 style="margin:0px;">07</h1>
												</td>
											</tr>
											
											<tr>
												<td style="text-align:center;">
													<input type="file" name="image_upload_07" id="image_upload_07">
												</td>
											</tr>
											<tr>
												<td style="text-align:center;">
