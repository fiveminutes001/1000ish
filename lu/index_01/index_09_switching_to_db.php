...
{
	//GETTING DATA
	$.post("Daniel_5224/targilim.php",{b_1: a}, function(result,b_2,m)
	{
		...
		var n_minus_5 = n - 5;
		//console.log(n);
		var subject = str.substr(5, n_minus_5);
		//console.log("="+subject+"=");
...
<div class="header" style="overflow:hidden;">
	<!-- PEOPLE HEADER -->
	<div id="div_people_button" onclick="people_and_subjects(1)" style="width:50%;display:inline-block;float:right;margin:10px 0px;border:1px black solid;border-left:0px;">	
		<h1 id="div_people_header" style="margin-bottom:0px;display:inline;">אנשים</h1>
		<h1 style="margin-bottom:0px;display:inline;"></h1>
	</div>
	
	<!-- SUBJECTS HEADER -->
	<div id="div_subjects_button" onclick="people_and_subjects(2)" style="width:50%;display:inline-block;float:left;margin:10px 0px;border:1px black solid;">	
	...
	<!-- 1000ish LOGO -->
	<div id="div_name_logo" style="width:100%;display:inline-block;margin:16px 0px 0px 0px;display:none;">	
