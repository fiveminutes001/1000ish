...
<div class="header" style="overflow:hidden;">
	<!-- PEOPLE HEADER -->
	<div id="div_people_button" onclick="people_and_subjects(1)" style="width:33.33%;display:inline-block;float:right;margin:10px 0px 0px 0px;border:1px black solid;border-left:0px;">	
		<h1 id="div_people_header" style="margin-bottom:0px;display:inline;">אנשים</h1>
		<h1 style="margin-bottom:0px;display:inline;"></h1>
	</div>
	
	<!-- SUBJECTS HEADER -->
	<div id="div_subjects_button" onclick="people_and_subjects_1st_load_physics()" style="width:33.33%;display:inline-block;float:left;margin:10px 0px 0px 0px;border:1px black solid;">	
		<h1 id="div_subjects_header" style="margin-bottom:0px;display:inline;">פיזיקה</h1>
		<h1 style="margin-bottom:0px;display:inline;"></h1>
	</div>
	
	<!-- SUBJECTS HEADER -->
	<div id="div_subjects_button_02" onclick="people_and_subjects_1st_load_math()" style="width:33.33%;display:inline-block;float:left;margin:10px 0px 0px 0px;border:1px black solid;border-style:solid solid solid hidden;">	
		<h1 id="div_subjects_header" style="margin-bottom:0px;display:inline;">מתמטיקה</h1>
		<h1 style="margin-bottom:0px;display:inline;"></h1>
	</div>
	...
	<div id="div_people" class="header " style="white-space:nowrap;overflow:hidden;">
		...
		<div class="initial_width button_">
			<div onclick="show_work('YOSHIYAHU')" class="initial_width to_complete">
				יאשיהו
			</div>
		</div>
		...
		<!-- JOY BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('JOY')" class="initial_width to_complete">
				JOY
			</div>
		</div>
		...
		<!-- קבוצה 02 BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('GROUP 02')" class="initial_width to_complete">
				קבוצה 02
			</div>
		</div>
		...
		<!-- SHON BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('SHON')" class="initial_width to_complete">
				שון
			</div>
		</div>
		...
		<!-- ITAY BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('ITAY')" class="initial_width to_complete">
				איתי
			</div>
		</div>
		...
		<!-- DANIEL BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('DANIEL')" class="initial_width to_complete">
				דניאל
			</div>
		</div>
		...
		<!-- OMRI BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('OMRI')" class="initial_width to_complete">
				עומרי
			</div>
		</div>
		...
		<!-- EVYATAR BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_work('EVYATAR')" class="initial_width to_complete">
				אביתר
			</div>
		</div>
		...
		<!-- BEN_PL BUTTON  -->
		<div class="initial_width button_">
			<div onclick="show_('BEN_PL')" class="initial_width to_complete">
				בן <i style="font-size:10px;margin-top:-6px;border-radius:2px;" class="em em-airplane"></i>
			</div>
		</div>
	...
	<div id="div_subjects" class="header">
		...
		<!-- MATH -->
		<div id="math_buttons" class="initial_width button_02_ subjects" style="width:100%;">
			<!-- MATH 800 -->
			<div style="display:block;">
				...
				<div class="initial_width button_02_">
					<div onclick="show_targil('math','math_800_001')" class="initial_width to_complete_02" style="white-space:initial;">
						משוואות ממעלה ראשונה עם נעלם במכנה
					</div>
					
					<div onclick="show_targil('math','math_800_002')" class="initial_width to_complete_02">
						משפט פיתגורס
					</div>
					
					<div onclick="show_targil('math','math_800_003')" class="initial_width to_complete_02">
						בעיות אחוזים
					</div>
					
					<div onclick="show_targil('math','math_800_004')" class="initial_width to_complete_02">
						מכנה משותף, כפל וחילוק שברים
					</div>
				</div>
				
				<div class="initial_width button_02_">
					<div onclick="show_targil('math','math_800_005')" class="initial_width to_complete_02">
			...
			<div style="display:block;width:50%;float:right;">
				...
				<div id="subjects_content" class="initial_width">
					<div onclick="show_targil('math','math_804_001')" class="initial_width math_804">
						בעיות קניה ומכירה
					</div>
					
					<div onclick="show_targil('math','math_804_002')" class="initial_width math_804">
						בעיות מילוליות עם אחוזים מבגרויות
					</div>
					
					<div onclick="show_targil('math','math_804_003')" class="initial_width math_804">
						בעיות קיצון
					</div>
					
					<div onclick="show_targil('math','math_804_004')" class="initial_width math_804">
			...
			<div style="display:block;width:50%;float:right;">
				...
				<div class="initial_width">
					<div onclick="show_targil('math','math_805_001')" class="initial_width math_804">
						בקרוב
					</div>
					
					<div onclick="show_targil('math','math_805_002')" class="initial_width math_804">
						בקרוב
					</div>
					
					<div onclick="show_targil('math','math_805_003')" class="initial_width math_804">
						בקרוב
					</div>
					
					<div onclick="show_targil('math','math_805_004')" class="initial_width math_804">
						בקרוב
					</div>
					
					<div onclick="show_targil('math','math_805_005')" class="initial_width math_804">
						בקרוב
					</div>
				</div>
			</div>
			...
			<div style="display:block;width:50%;float:right;">
				...
				<div class="initial_width">
					<div onclick="show_targil('math','math_806_001')" class="initial_width to_complete_04">
						בעיות תנועה
					</div>
					
					<div onclick="show_targil('math','math_806_002')" class="initial_width to_complete_04">
						בעיות הספק
					</div>
					
					<div onclick="show_targil('math','math_806_003')" class="initial_width to_complete_04">
						סדרה חשבונית
					</div>
					
					<div onclick="show_targil('math','math_806_004')" class="initial_width to_complete_04">
						סדרה הנדסית
					</div>
					
					<div onclick="show_targil('math','math_806_005')" class="initial_width to_complete_04">
						הסתברות
					</div>
				</div>
			</div>
			...
			<div style="display:block;width:50%;float:right;">
				...
				<div class="initial_width">
					<div onclick="show_targil('math','math_807_001')" class="initial_width to_complete_04">
						בקרוב
					</div>
					
					<div onclick="show_targil('math','math_807_002')" class="initial_width to_complete_04">
						בקרוב
					</div>
				</div>
			</div>
...
<div class="header inside_div">
	<div style="width:100%;">	
		<h1 style="margin-bottom:0px;display:inline;">יאשיהו // 17.03.19</h1>
	</div>
